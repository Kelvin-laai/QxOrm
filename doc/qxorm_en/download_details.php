  ...
  <td align="right" valign="top">
    <table cellspacing="0" cellpadding="1"><col><col><tbody>
      <tr>
         ...
         <td align="left" valign="top"><font size="2" class="txt_with_shadow">QxOrm 1.5.1 - <a href="../doxygen/index.html" target="_blank">QxOrm library online class documentation</a> - <a href="https://github.com/QxOrm/QxOrm" target="_blank">GitHub</a> - <a href="https://hub.docker.com/u/qxorm" target="_blank">Docker</a></font></td>
      </tr>
      <tr>
         <td align="right" valign="top"><font size="2" class="txt_with_shadow"></font></td>
         <td align="left" valign="top"><font size="2" class="txt_with_shadow">QxEntityEditor 1.3.1</font></td>
      </tr>
    </tbody></table>
  </td>
  <td width="10px"></td>
  ...
  <tbody>
    <tr>
      <td align="justify">
         ...
         <br/>
         <a href="../php/add_download.php5?file_path=QxOrm_1.5.1.zip&file_desc=QxOrm_1.5.1" class="btn_tuto" target="_blank">Download QxOrm 1.5.1</a>
         <br/>
         <!--
...
function checkForm(f) { f.submit(); return true; }
         ...
         <form action="../php/add_download.php" method="POST" onSubmit="return checkForm(this);">
            ...
            <input type="submit" value="            Download QxOrm 1.5.1            " />
         </form>
         -->
         <br>
      </td>
