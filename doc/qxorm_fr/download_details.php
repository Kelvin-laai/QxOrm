  ...
  <tbody>
    <tr>
      <td align="justify">
         ...
         <br/>
         <a href="../php/add_download.php5?file_path=QxOrm_1.5.1.zip&file_desc=QxOrm_1.5.1" class="btn_tuto" target="_blank">Télécharger QxOrm 1.5.1</a>
         <br/>
         <!--
...
function checkForm(f) { f.submit(); return true; }
         ...
         <form action="../php/add_download.php" method="POST" onSubmit="return checkForm(this);">
            ...
            <input type="submit" value="            Télécharger QxOrm 1.5.1            " />
         </form>
         -->
         <br>
      </td>
